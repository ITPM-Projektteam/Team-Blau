...
type TKI = class(TObject)
  ...
  public
      class procedure Init(IP_Adressen: Array of String; Server_Adresse: String; Port: Integer);
...
class procedure TKI.Init(IP_Adressen: Array of String; Server_Adresse: String; Port: Integer);
var i: Integer;
begin
